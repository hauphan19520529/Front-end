    ...
    <div class="tablez">
	    ...
	    <form class="default-form" >
	    	<div class="header-form">
	    	    <h1>Tạo tài khoản</h1>
	    	    <p>hãy điền thông tin để đăng kí trở thành thành viên của GameInfo</p>
	    	</div>
	    	<div class="inner-from">
	    	    <label>Tên của bạn:</label>
	    	    <input type="text" id="ten" className="barz" placeholder=" Nhập tên của bạn tại đây" required/>
	    	    <label>Email: </label>
	    	    <input type="email" id="mail" className="barz" placeholder=" Nhập Email của bạn tại đây" required/>
	    	    <label>Tên đăng nhập: </label>
	    	    <input type="text" id="tk" className="barz" placeholder=" Nhập tên đăng nhập/username của bạn tại đây" required/>
	    	    <label>Mật khẩu: </label>
	    	    <input type="password" id="mk" className="barz" placeholder=" Nhập mật khẩu của bạn tại đây" required/>	
	    	</div>		
	    	    <button type="submit" id="form-btn" class="form-btn">Đăng kí</button>
